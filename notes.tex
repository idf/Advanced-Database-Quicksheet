...
\begin{enumerate}
\item Until completion: failures $\ra$ Failure Recovery (FP)
...
\item \textbf{Commit log on disk after}: before commit is flushed to log, all writes of transaction must be reflected on disk.
\end{enumerate}
